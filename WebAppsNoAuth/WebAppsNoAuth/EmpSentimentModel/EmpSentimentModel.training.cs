...
namespace EmpSentimentModel.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"/Users/mishalrizvi/Projects/TeamManager/WebAppsNoAuth/WebAppsNoAuth/wwwroot/training_data_tabbed.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"feedback",outputColumnName:@"feedback")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=15,MinimumExampleCountPerLeaf=11,NumberOfTrees=251,MaximumBinCountPerFeature=8,FeatureFraction=0.9721126928492524,LearningRate=0.9999997766729865,LabelColumnName=@"nine_box_category",FeatureColumnName=@"Features"}),labelColumnName: @"nine_box_category"))      
